      ...
      builder: (context, controller) {
        return PopupMenuButton<_MenuOptions>(
          onSelected: (value) async {
            switch (value) {
              case _MenuOptions.navigateToPdfDocs:
                await controller.data!.loadUrl('https://www.postgresql.org/docs/');
                break;
              case _MenuOptions.navigateToWordDocs:
                await controller.data!
                    .loadUrl('https://templates.office.com/en-us/basic-design-blank-template-tm16392878');
                break;
...
req.send();''');
          ...
          itemBuilder: (context) => [
            const PopupMenuItem<_MenuOptions>(
              value: _MenuOptions.navigateToPdfDocs,
              child: Text('Navigate to Pdf Docs'),
            ),
            const PopupMenuItem<_MenuOptions>(
              value: _MenuOptions.navigateToWordDocs,
              child: Text('Navigate to Word Docs'),
            ),
            const PopupMenuItem<_MenuOptions>(
  ...
  Future<void> _onRemoveCookie(WebViewController controller) async {
    await controller.runJavascript('document.cookie="FirstName=John; expires=Thu, 01 Jan 1970 00:00:00 UTC" ');
    if (!mounted) return;
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
